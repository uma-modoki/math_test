            ...
            <div id="menu">
                <section id="menu1">
                    ...
                    <div id="menu1_main" class="menu_main">
                        <p>次のいずれか1つの項目にキーワードを入力し、「検索」ボタンをクリックしてください。</p>
                        <form action="">
                            <table>
                                <tr>
                                    <td><label for="radio1">IDで検索</label></td>
                                    <td>
                                ...
                                <tr>
                                    <td><label for="radio2">名前で検索</label></td>
                                    <td>
                                ...
                                <tr>
                                    <td><label for="radio3">カテゴリで検索</label></td>
                                    <td>
                                ...
                                <tr>
                                    <td><label for="radio4">階級で検索</label></td>
                                    <td>
                                ...
                                <tr>
                                    <td><label for="radio5">メッセージで検索</label></td>
                                    <td>
                                        <input type="radio" id="radio5" name="radio" value="E">
                                        <input type="text" name="search_word" id="text_massage" class="text">
                                    </td>
                                </tr>
                            </table>
                    ...
                    <div id="menu3_main" class="menu_main">
                        ...
                        <form action="./bbs_delete.php" method="get">
                            <table>
                                ...
                                <tr>
                                    <td>管理パスワード</td><td><input type="password" maxlength="8" pattern="^([0-9A-za-z]{4,8})$" title="4文字以上8文字以下の半角英数字で入力してください" name="password" id="password" class="text" required >※パスワードはpasswordです</td>
                                </tr>
                                <tr>
